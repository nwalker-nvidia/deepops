...
export KFCTL_FILE=kfctl_v1.2.0-0-gbc038f9_linux.tar.gz # https://github.com/kubeflow/kfctl/releases/tag/v1.3.0-rc.1
...
https://github.com/kubeflow/kubeflow/archive/refs/tags/v1.3.0-rc.1.tar.gz
